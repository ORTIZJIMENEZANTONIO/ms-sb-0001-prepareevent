    ...
    for (const result of results) {
      ...
      if (exists.count == 0) {
        ...
        try {
          ...
          console.error(
            (_a = error.detail) !== null && _a !== void 0 ? _a : error
          );
  ...
  async paRemittancePrepByGood(params) {
    ...
    if (query2[0].tpEventId == 10) {
      ...
      if (valEvn6 == 0) {
        ...
        const newId =
          (_a = await this.entityComerRejected.query(
      ...
      if (sumValFinal >= 1 && query3[0].goodRejected == 0) {
        const newId =
          (_b = await this.entityComerRejected.query(
            `SELECT NEXTVAL('comer_bienesrechazados_seq')`
          )) !== null && _b !== void 0
            ? _b
            : 1;
...
PaProcessService = __decorate(
  [
    ...
    __param(
      0,
      (0, typeorm_1.InjectRepository)(comer_event_entity_1.ComerEventEntity)
    ),
    __param(1, (0, typeorm_1.InjectRepository)(goods_entity_1.GoodsEntity)),
    __param(
      2,
      (0, typeorm_1.InjectRepository)(comer_lot_entity_1.ComerLotEntity)
    ),
    __param(
      3,
