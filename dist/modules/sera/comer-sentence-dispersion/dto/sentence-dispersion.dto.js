...
], SentenceDispersionDto.prototype, "eventId", void 0);
__decorate([
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNotEmpty)({
        message: message_1.Message.REQUIRED("$property"),
    ...
    (0, swagger_1.ApiProperty)({ example: 1, required: true }),
    __metadata("design:type", Number)
], SentenceDispersionDto.prototype, "lotId", void 0);
__decorate([
...
], SentenceDispersionDto.prototype, "uspen", void 0);
exports.SentenceDispersionDto = SentenceDispersionDto;
//# sourceMappingURL=sentence-dispersion.dto.js.map