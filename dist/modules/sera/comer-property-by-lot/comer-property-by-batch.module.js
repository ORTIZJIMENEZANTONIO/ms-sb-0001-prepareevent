...
const comer_property_by_lot_entity_1 = require("./entities/comer-property-by-lot.entity");
let ComerPropertyByBatchModule = class ComerPropertyByBatchModule {
};
ComerPropertyByBatchModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([comer_property_by_lot_entity_1.ComerGoodsXLotEntity])],
